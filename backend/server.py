...
- Giảng viên: Đội ngũ quốc tế và chuyên gia từ các tập đoàn lớn, mang lại trải nghiệm học tập thực chiến.
...
def chat():
    try:
        ...
        error_msg = str(e)
        logger.error(f"❌ API Error 503: {error_msg}") # Log chính xác lỗi 503 tại đây!
        
        # Trả về 503 cho server log, nhưng vẫn kèm JSON để Frontend hiển thị hotline
        return jsonify({
            'success': False,
